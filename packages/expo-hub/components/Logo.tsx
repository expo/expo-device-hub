...
/**
 * The Expo wordmark — ported from the website's `WordMarkLogo`
 * (`@expo/styleguide`). Rendered at `w-18` with `text-default`, like the
 * website nav. Purely decorative here: it does not link anywhere and is not
 * selectable, copiable, or draggable.
 */
