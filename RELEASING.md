...
vendored artifacts match the versions being published. Build or test failures stop publication;
real releases have already pushed the version commit so EAS can check it out.
